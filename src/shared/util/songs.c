...
const BuzzerSequence buzzSeqTetris = {(uint16_t[]){
	2637, 375,
	0, 54,
	2637, 375,
	0, 54,
...
static const Song songList[] = {
	...
	{ BUZZ_UP20, "up20", &buzzSeqUp20 },
	{ BUZZ_UPDOWN20, "updown20", &buzzSeqUpDown20 },
	{ BUZZ_DOUBLE_SLOW, "doublebeep", &buzzSeqDoubleBeepSlow },
	{ BUZZ_UP100, "up100", &buzzSeqUp100 },
...
{
	*ppSongs = songList;
	*pNumSongs = sizeof(songList) / sizeof(songList[0]);
}
