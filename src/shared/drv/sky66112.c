...
static int16_t setMode(void* pInterfaceData, FEMMode mode)
{
	SKY66112* pSky = (SKY66112*)pInterfaceData;

    switch(mode)
    {
        case FEM_MODE_OFF: SKY66112SetMode(pSky, SKY66112_MODE_OFF); break;
        case FEM_MODE_RX: SKY66112SetMode(pSky, SKY66112_MODE_RX); break;
        case FEM_MODE_TX: SKY66112SetMode(pSky, SKY66112_MODE_TX); break;
        default: return 1;
    }
...
{
    pInterface->pInterfaceData = pSky;
    pInterface->setModeFunc = &setMode;
}
