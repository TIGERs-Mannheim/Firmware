...
const LogMessageDesc logMessageDescriptions[10] = {
	...
	{ SID_CTRL_STATE, "ctrl_state", 23, (ElementDesc[]) {
		...
		{ FLOAT,	"dribbler_kf", "Nms", "Dribbler viscous friction"},
		{ FLOAT,	"dribbler_vel", "m/s", "Dribbler surface speed"},
		{ FLOAT,	"dribbler_force", "N", "Dribbler surface force"},
		{ UINT32,	"dribbler_state", "enum", "Dribbler state" },

		{ UINT32,	"ball_state", "enum", "Ball detection state" },
		{ FLOAT,	"ball_pos_x", "m", "Ball X position in dribbler frame"},
		{ FLOAT,	"ball_pos_y", "m", "Ball Y position in dribbler frame"},
		{ FLOAT,	"ball_vel_x", "m/s", "Ball X velocity in dribbler frame"},
		{ FLOAT,	"ball_vel_y", "m/s", "Ball Y velocity in dribbler frame"},
	}, },
	{ SID_CTRL_OUTPUT, "ctrl_output", 21, (ElementDesc[]) {
		...
		{ FLOAT,	"drib_vol", "V", "Dribbler voltage" },
		{ FLOAT,	"drib_vel", "rad/s", "Dribbler velocity limit" },
		{ FLOAT,	"drib_torque", "Nm", "Dribbler torque limit" },
		{ UINT32,	"drib_mode", "-", "Dribbler controller mode"},
	}, },
	...
	{ SID_CTRL_REF, "ctrl_ref", 11, (ElementDesc[]) {
	...
	{ SID_SKILL_OUTPUT, "skill_output", 28, (ElementDesc[]) {
		...
		{ FLOAT,	"dribbler_vel", "m/s", "Dribbler surface speed" },
		{ FLOAT,	"dribbler_max_force", "N", "Dribbler Max. Force" },
		{ FLOAT,	"dribbler_voltage", "V", "Dribbler Voltage" },
	...
	{SID_RECEIVE_BALL, "receive_ball", 13, (ElementDesc[]) {
		{ FLOAT,	"s_ball_x", "m", "BallPos Sumatra X" },
		{ FLOAT,	"s_ball_y", "m", "BallPos Sumatra Y" },
		{ UINT32,	"s_time", "us", "Capture Time Sumatra" },
		{ FLOAT,	"r_ball_x", "m", "BallPos RobotPi X" },
		{ FLOAT,	"r_ball_y", "m", "BallPos RobotPi Y" },
		{ UINT32,	"r_time", "us", "Capture Time RobotPi" },
		{ FLOAT,	"s_recv_x", "m", "Sumatra ReceivePose Y" },
		{ FLOAT,	"s_recv_y", "m", "Sumatra ReceivePose X" },
		{ FLOAT,	"s_recv_angle", "m", "Sumatra ReceivePose Angle" },
		{ FLOAT,	"k_recv_x", "m", "Kicker ReceivePos X" },
		{ FLOAT,	"k_recv_y", "m", "Kicker ReceivePos Y" },
		{ FLOAT,	"r_recv_x", "m", "Robot ReceivePos X" },
		{ FLOAT,	"r_recv_y", "m", "Robot ReceivePos Y" },
	}, },
};
