...
static const ConfigFileDesc configFileDescDriveTrain =
	{ SID_CFG_CTRL_DRIVE_TRAIN, 4, "ctrl/drive_train", 8, (ElementDesc[]) {
...
static const ConfigFileDesc configFileDescDribbler =
	{ SID_CFG_CTRL_DRIBBLER, 2, "ctrl/dribbler", 9, (ElementDesc[]) {
...
void CtrlControl(const RobotCtrlState* pState, const DriveInput* pInput, RobotCtrlOutput* pOutput, RobotCtrlReference* pRef)
{
