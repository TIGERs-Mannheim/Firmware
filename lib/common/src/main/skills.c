...
#include <main/skill_sine.h>
#include <main/skills.h>
#include <main/skill_fast_pos.h>
#include <main/skill_circle_ball.h>
#include <main/skill_penalty_shoot.h>
#include <main/skill_get_ball.h>
#include <main/skill_intercept_ball.h>
