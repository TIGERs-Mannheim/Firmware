...
const LogMessageDesc logMessageDescriptions[10] = {
	...
	{ SID_SENSORS, "sensors", 74, (ElementDesc[]) {
		// 0 + 5
		...
		// 36 + 6
		{ FLOAT,	"dribbler_speed", "RPM", "Dribbler speed" },
	...
	{ SID_CTRL_STATE, "ctrl_state", 17, (ElementDesc[]) {
		{ FLOAT,	"pos_x", "m", "X Position" },
		{ FLOAT,	"pos_y", "m", "Y Position" },
	...
	{ SID_CTRL_OUTPUT, "ctrl_output", 19, (ElementDesc[]) {
		...
		{ UINT32,	"drib_mode", "-", "Dribbler mode" },
	}, },
	...
	{ SID_SKILL_OUTPUT, "skill_output", 27, (ElementDesc[]) {
		{ FLOAT,	"pos_x", "m", "X Position" },
		{ FLOAT,	"pos_y", "m", "Y Position" },
		{ FLOAT,	"pos_z", "rad", "Z Position" },
