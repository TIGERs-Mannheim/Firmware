...
#define IC_TEST_COMPASS_CALIB	7
#define IC_TEST_KICKER			8
#define IC_TEST_MOT_CURRENT		9
#define IC_TEST_MOT_IDENT		10
#define IC_TEST_MOT_IDENT_ALL	11
#define IC_TEST_MOT_RESISTANCE	12
...
typedef struct PACKED _TestProgress
{
	uint8_t testId;
	uint8_t motorId;
...
typedef struct PACKED _TestMotorDynamicsResult
{
...
} TestMotorDynamicsResult;

typedef struct PACKED _TestKickerResult
{
