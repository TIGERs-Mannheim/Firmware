...
void RobotImplInit()
{
	...
	ctrlPantheraConfigDribblerDesc.cfgId = SID_CFG_CTRL_PANTHERA_DRIBBLER_V2016;
	ctrlPantheraConfigDribblerDesc.version = 0;
	ctrlPantheraConfigDribblerDesc.pName = "v2016/dribbler";
...
void RobotImplUpdateSensors(RobotSensors* pSensors)
{
	...
	// Dribbler
	pSensors->dribbler.speed = motors.dribbler.velocity;
...
void RobotImplDribblerOutput(const RobotCtrlOutput* pCtrlOut)
{
	...
	case DRIBBLER_MODE_VOLTAGE:
		MotorsDribblerSetVoltage(pCtrlOut->dribblerVoltage);
		break;
	default:
		MotorsDribblerOff();
		break;
