...
local_src_dirs := src src/hal src/usb src/gui
...
local_include_dirs += -I lib/common/src/ugfx -I lib/common/src/ugfx/drivers/gdisp/ILI9341
local_defines := -DHSE_VALUE=12000000 -DSTM32F7XX -DSTM32F746xx
...
local_libs := lib/libf7xx.a lib/libdsp.a
local_libs_d := lib/libf7xx_d.a lib/libdsp_d.a
