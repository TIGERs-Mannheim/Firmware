...
void TFTInit()
{
	...
	FMC_Bank1->BTCR[0] = FMC_BCR1_MWID_0 | FMC_BCR1_WREN | FMC_BCR1_WFDIS | 0x80;
	FMC_Bank1->BTCR[1] = (5 << FMC_BTR1_DATAST_Pos);	// DataSetupTime = 5
	FMC_Bank1->BTCR[0] |= FMC_BCR1_MBKEN | FMC_BCR1_FMCEN;
